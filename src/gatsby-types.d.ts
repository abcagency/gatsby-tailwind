...
type DefaultPageHeadQueryQueryVariables = Exact<{ [key: string]: never; }>;


type DefaultPageHeadQueryQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly author: string | null, readonly ogImage: string | null } | null } | null };
